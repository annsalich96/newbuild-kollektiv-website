...
| 15 | Sponsoren-Laufband | 1–12 | 26 | Text Bold (43pt) | **Offen:** Abweichung von Startseite (dort Text Capital) — Absicht oder Kopierfehler? Noch nicht umgesetzt, siehe unten. |
...
- **Nr. 15 (Sponsoren-Laufband-Schrift):** Tabelle nennt Text Bold 43pt, Code nutzt bisher Text Capital 24pt (wie auf der Startseite). Noch nicht geändert, bis geklärt ist, ob das Absicht ist — eine Umstellung würde die Sponsoren-Leiste optisch deutlich von der Homepage abweichen lassen.
